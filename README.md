...
### 🔥Highlight!!
[1], Two concurrent works ([Huang et al.](https://arxiv.org/abs/2402.17525), [Cao et al.](https://arxiv.org/abs/2403.04279)) are related to our survey. Huang et al. introduce the application of diffusion models in image editing, while Cao et al. focus on the controllable image generation. Compared with the review from Huang et al. and previous literature, we investigate the image editing in a more general way. In our discussion, the preserved concepts are not confined to low-semantic semantics, where the customization task also complies our topic. We integrate existing general editing methods into a unified framework, and provide a design space for userers through qualitative and quantitative analyses.

[2], In this repo, we organize the reviewed methods based on the editing task, and present their inversion & editing algorithms, along with their guidance set. It's worth note that many of these studies employ multiple editing algorithms simultaneously. For simplicity, we have currently only indicate the primary technology they use. 


[3], We hope our work can help researchers explore novel combinations within our framework, thereby improving the performance in challenging scenarios.
...
| ICCV 2023 | [Effective Real Image Editing with Accelerated Iterative Diffusion Inversion](https://arxiv.org/abs/2309.04907) |  text  | $F_{inv}^F+F_{edit}^{Norm}$ |[Code]()|
...
| Publication |    Paper Title     |    Guidance Set      | Combination                                                                                                            | Code/Project                                                 |
|:----:|:-----------------------------------------------------------------------------------------------------------------------:|:---------------:|:-------:|--------------------------------------------------------------|
| Arxiv 2024 | [DesignEdit: Multi-Layered Latent Decomposition and Fusion for Unified & Accurate Image Editing](https://arxiv.org/abs/2403.14487) |    user interface     | $F_{inv}^F+F_{edit}^{Attn}$  |[Code](https://github.com/design-edit/DesignEdit)|
...
| Publication |    Paper Title     |    Guidance Set      | Combination                                                                                                            | Code/Project                                                 |
|:----:|:-----------------------------------------------------------------------------------------------------------------------:|:---------------:|:-------:|--------------------------------------------------------------|
| Arxiv 2023 |  [HD-Painter: High-Resolution and Prompt-Faithful Text-Guided Image Inpainting with Diffusion Models](https://arxiv.org/abs/2312.14091) |    text + mask     | $F_{inv}^F+F_{edit}^{Attn}$|[Code](https://github.com/Picsart-AI-Research/HD-Painter)|
| ICCV 2023 | [TF-ICON: Diffusion-Based Training-Free Cross-Domain Image Composition](https://arxiv.org/abs/2307.12493) |    text + image    |$F_{inv}^F+F_{edit}^{Blend}$ |[Code](https://github.com/Shilin-LU/TF-ICON)|
...
| Arxiv 2022 | [High-Resolution Image Editing via Multi-Stage Blended Diffusion](https://arxiv.org/abs/2210.12965) |    text + mask    | $F_{inv}^F+F_{edit}^{Blend}$  |[Code](https://github.com/pfnet-research/multi-stage-blended-diffusion)|
...
| Publication |    Paper Title     |    Guidance Set      | Combination                                                                                                            | Code/Project                                                 |
|:----:|:-----------------------------------------------------------------------------------------------------------------------:|:---------------:|:-------:|--------------------------------------------------------------|
| CVPR 2023  |  [Inversion-Based Style Transfer with Diffusion Models](https://arxiv.org/abs/2211.13203) |    text + image   | $F_{inv}^T+F_{inv}^F+F_{edit}^{Attn}$  | [Code](https://github.com/zyxElsa/InST)|
...
|SIGGRAPH 2023 | [Domain-Agnostic Tuning-Encoder for Fast Personalization of Text-To-Image Models](https://arxiv.org/abs/2307.06925)  |  text  | [Code](https://arxiv.org/abs/2305.14720)|
